...
const DwpDetailPage: React.FC = () => {
  const router = useRouter();
  const { id } = router.query;
  const [app, setApp] = useState<DwpApp | null>(null);
      ...
      {loading ? (
        ...
        <>
          <Table variant="simple" maxW="500px" mb={4}>
            <Tbody>
              <Tr>
                <Td fontWeight="bold">Application ID</Td>
...
export default withAuth(DwpDetailPage);